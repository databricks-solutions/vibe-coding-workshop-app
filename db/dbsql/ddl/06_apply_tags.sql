-- =============================================================================
-- Unity Catalog Tags for Vibe Coding Workshop Resources (DBSQL / Delta)
-- =============================================================================
...
-- entity-tag-assignments commands (not JDBC, since UC tags require the
-- Databricks control plane).
--
-- This file serves as the canonical tag definition reference.
-- Placeholders are substituted at deploy time (same tokens as Lakebase flow):
--   __LAKEBASE_CATALOG__  -> UC catalog name
--   __LAKEBASE_SCHEMA__   -> schema name
