...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'sample', 'Sample', 'booking', 'Booking App', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'retail', 'Retail', 'customer_data_management', 'Customer Data Management', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'retail', 'Retail', 'marketing_growth', 'Drive Marketing Growth', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'retail', 'Retail', 'engage_convert', 'Engage & Convert Customers', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'retail', 'Retail', 'maximize_roi', 'Maximize ROI', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'retail', 'Retail', 'commerce_media', 'Commerce Media Networks', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'retail', 'Retail', 'employee_360', 'Employee 360', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'retail', 'Retail', 'agentic_workforce', 'Agentic Workforce', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'retail', 'Retail', 'supply_chain_risk', 'Supply Chain Risk Management', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'retail', 'Retail', 'demand_inventory', 'Demand & Inventory Optimization', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'retail', 'Retail', 'supplier_collaboration', 'Supplier Collaboration', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'cpg', 'CPG', 'shopper_insights', 'Shopper Insights', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'cpg', 'CPG', 'brand_insights', 'Brand Insights', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'cpg', 'CPG', 'retailer_insights', 'Retailer Insights', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'cpg', 'CPG', 'cpg_employee_360', 'Employee 360', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'cpg', 'CPG', 'cpg_agentic_workforce', 'Agentic Workforce', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'cpg', 'CPG', 'cpg_supply_chain_risk', 'Supply Chain Risk Management', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'cpg', 'CPG', 'cpg_demand_inventory', 'Demand & Inventory Optimization', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'cpg', 'CPG', 'cpg_supplier_collaboration', 'Supplier Collaboration', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'cpg', 'CPG', 'revenue_growth_mgmt', 'Revenue Growth Management', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'cpg', 'CPG', 'portfolio_innovation', 'Portfolio Optimization & Innovation', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'travel', 'Travel & Hospitality', 'travel_customer_data', 'Customer Data Management', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'travel', 'Travel & Hospitality', 'customer_insights_activation', 'Customer Insights & Activation', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'travel', 'Travel & Hospitality', 'travel_employee_360', 'Employee 360', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'travel', 'Travel & Hospitality', 'travel_agentic_workforce', 'Agentic Workforce', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'travel', 'Travel & Hospitality', 'call_center_ops', 'Call Center Operations', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'travel', 'Travel & Hospitality', 'dynamic_pricing', 'Dynamic Pricing & Promotion', 
...
(industry, industry_label, use_case, use_case_label, prompt_template, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'sample', 'Sample', 'build_skill', 'Build a Data Contract Skill', 
