...
(section_tag, input_template, system_prompt, section_title, section_description, order_number, how_to_apply, expected_output, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'prd_generation',
...
-- Figma UI Design
INSERT INTO ${catalog}.${schema}.section_input_prompts 
(section_tag, input_template, system_prompt, section_title, section_description, order_number, how_to_apply, expected_output, bypass_llm, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'figma_ui_design',
...
(section_tag, input_template, system_prompt, section_title, section_description, order_number, how_to_apply, expected_output, bypass_llm, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'bronze_table_metadata_generate',
...
(section_tag, input_template, system_prompt, section_title, section_description, order_number, how_to_apply, expected_output, bypass_llm, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'genie_silver_metadata_generate',
...
INSERT INTO ${catalog}.${schema}.section_input_prompts 
(section_tag, input_template, system_prompt, section_title, section_description, order_number, how_to_apply, expected_output, bypass_llm, step_enabled, version, is_active, inserted_at, updated_at, created_by)
VALUES
( 'optimize_genie',
