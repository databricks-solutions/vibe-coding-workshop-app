    ...
    return (
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
          ...
          <span className="text-[11px] text-white/80 bg-black/50 px-2.5 py-1 rounded-full flex items-center gap-1.5">
          ...
          <div className="px-4 sm:px-6 pb-6">
            ...
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[14px] font-semibold text-foreground mb-3">3 Key Learnings:</p>
              ...
              <div className="w-full lg:w-[380px] lg:flex-shrink-0">
                <div className="rounded-xl overflow-hidden border border-border bg-slate-900/50 shadow-lg">
                  <div className="px-3 py-2 bg-slate-800/80 border-b border-border">
                    <p className="text-[11px] font-medium text-slate-400 uppercase tracking-wide flex items-center gap-2">
            ...
            {onGetStarted && (
              <div className="flex justify-center pt-4 pb-1">
                {hasStarted ? (
                  <div className="inline-flex items-center gap-2 px-5 py-2 rounded-lg bg-emerald-500/15 text-emerald-400 border border-emerald-500/30 text-[13px] font-medium animate-fade-in">
                  ...
                  <BorderBeamButton
                    ...
                    className="px-8 py-3 text-[15px] font-semibold inline-flex items-center gap-2.5"
                  >
