...
const GROUP_ORDER = ['Foundation', 'Chapter 1', 'Chapter 2', 'Chapter 3', 'Chapter 4', 'Refinement'];
...
const GROUP_STYLES: Record<string, { label: string; bg: string; border: string; text: string; dot: string }> = {
  ...
  'Chapter 1':   { label: 'App',              bg: 'bg-red-500/8',    border: 'border-red-500/20',    text: 'text-red-400',    dot: 'bg-red-500' },
  'Chapter 2':   { label: 'Lakebase',          bg: 'bg-violet-500/8', border: 'border-violet-500/20', text: 'text-violet-400', dot: 'bg-violet-500' },
  'Chapter 3':   { label: 'Lakehouse',         bg: 'bg-amber-500/8',  border: 'border-amber-500/20',  text: 'text-amber-400',  dot: 'bg-amber-500' },
  'Chapter 4':   { label: 'Data Intelligence', bg: 'bg-cyan-500/8',   border: 'border-cyan-500/20',   text: 'text-cyan-400',   dot: 'bg-cyan-500' },
  'Refinement':  { label: 'Iterate',           bg: 'bg-pink-500/8',   border: 'border-pink-500/20',   text: 'text-pink-400',   dot: 'bg-pink-500' },
};
